...
for j in range(1,num_client+1):###############################################################
    ...
    if j <10:
        name_x_train = 'data_mnist_iid/' + 'client_0' + str(j) +'_x_train.npy'
        name_y_train = 'data_mnist_iid/' + 'client_0' + str(j) +'_y_train.npy'
    else:
        name_x_train = 'data_mnist_iid/' + 'client_' + str(j) +'_x_train.npy'
        name_y_train = 'data_mnist_iid/' + 'client_' + str(j) +'_y_train.npy'
