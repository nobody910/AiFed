...
for j in range(1,41):###############################################################
    ...
    Smin, Smax =950,1550 #the range of the local train data size
    ...
    if j <10:
        name_x_train = 'data_cifar10_noniid/' + 'client_0' + str(j) +'_x_train.npy'
        name_y_train = 'data_cifar10_noniid/' + 'client_0' + str(j) +'_y_train.npy'
    else:
        name_x_train = 'data_cifar10_noniid/' + 'client_' + str(j) +'_x_train.npy'
        name_y_train = 'data_cifar10_noniid/' + 'client_' + str(j) +'_y_train.npy'
