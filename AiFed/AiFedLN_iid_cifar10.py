...
from information_function import compute_label_number
import random
import os
...
save_path = 'results_'+type_dateset+'_'+name_dataset+'_save/AiFedLN_0606_result1.xlsx'
...
save_path_rc_m = 'results_'+type_dateset+'_'+name_dataset+'_save/AiFedLN_0606_result1_rc_m'#-----------
#####################################################################
...
for i in range(0,k):
    ...
    iw_all[i] = compute_label_number(y_train)#informative weights
...
cost_unit_model = 39.69#-------------------------------------------------------MB
cost_unit_shallow = 3.68
...
plot_result(global_model_test_acc,'AiFedLN','accuracy')
...
yag.send(to = ['1481209521@qq.com'], subject = '72服务器代码', contents = ['代码已运行完成'])
