...
type_dateset = 'iid'
name_dataset = 'fmnist'
save_path = 'results_'+type_dateset+'_'+name_dataset+'_save/AiFedLN_0602_result1.xlsx'
...
save_path_rc_m = 'results_'+type_dateset+'_'+name_dataset+'_save/AiFedLN_0602_result1_rc_m'#-----------
#####################################################################
...
plot_result(global_model_test_acc,'AiFed-LN','accuracy')
