...
save_path = 'results_'+type_dateset+'_'+name_dataset+'_save/AiFedIE_0606_result1.xlsx'
...
save_path_rc_m = 'results_'+type_dateset+'_'+name_dataset+'_save/AiFedIE_0606_result1_rc_m'#-----------
#####################################################################
...
yag.send(to = ['1481209521@qq.com'], subject = '79服务器代码', contents = ['代码已运行完成'])
